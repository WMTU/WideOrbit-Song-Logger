...
# song log query
log_query = "INSERT INTO play_log(play_date, play_time, timestamp, song, artist, album, genre, location, cd_id, artwork, logged_by) \
    VALUES(%(play_date)s, %(play_time)s, %(timestamp)s, %(song)s, %(artist)s, %(album)s, %(genre)s, %(location)s, %(cd_id)s, '', 'nobody');"
